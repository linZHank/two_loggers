...
register(
  id='Klotski-v0',
  entry_point='envs.klotski_task_env:KlotskiTaskEnv')


class KlotskiTaskEnv(LoggersRobotEnv):
  def __init__(self):
    """
    This task-env is designed for two mobile robot(loggers) linked by a rod find a way exit
    in world of wall exit. Action and state space will be both set to continuous. 
    """
    # action limits
