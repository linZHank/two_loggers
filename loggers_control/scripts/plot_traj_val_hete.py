...
# load trajectory
traj_dir = os.path.join(sys.path[0], 'saved_trajectories', 'hete_0')
...
model_paths_0 = [
    ...
    os.path.join(sys.path[0], 'saved_models/double_escape_discrete/dqn/2020-06-07-18-26/logger0/models/5839800.h5'),
]
model_paths_1 = [
    os.path.join(sys.path[0], 'saved_models/double_escape_discrete/dqn/2020-06-07-18-26/logger1/models/1000000.h5'),
    os.path.join(sys.path[0], 'saved_models/double_escape_discrete/dqn/2020-06-07-18-26/logger1/models/3000000.h5'),
    os.path.join(sys.path[0], 'saved_models/double_escape_discrete/dqn/2020-06-07-18-26/logger1/models/5839800.h5'),
]
# create figure
...
ax_q[0].text(200,50, r'Model version: $10^6$', fontsize=14, color='r')
ax_q[0].text(200,20, r'$\Delta Q = ${:.2f}'.format(qvals_mae[0]), fontsize=14, color='r')
...
ax_q[1].text(200,50, r'Model version: $3\times10^6$', fontsize=14, color='r')
ax_q[1].text(200,20, r'$\Delta Q = ${:.2f}'.format(qvals_mae[1]), fontsize=14, color='r')
...
ax_q[2].text(200,50, r'Model version: final', fontsize=14, color='r')
ax_q[2].text(200,20, r'$\Delta Q = ${:.2f}'.format(qvals_mae[2]), fontsize=14, color='r')
