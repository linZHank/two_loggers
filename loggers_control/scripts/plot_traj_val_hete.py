...
# load trajectory
traj_dir = os.path.join(sys.path[0], 'saved_trajectories', '2020-07-04-00-55')
...
ax_q[0].text(160,20, 'Model version: 1e6', fontsize=14, color='r')
...
ax_q[1].text(160,20, 'Model version: 3e6', fontsize=14, color='r')
...
ax_q[2].text(160,20, 'Model version: final', fontsize=14, color='r')
