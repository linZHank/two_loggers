...
if __name__=='__main__':
    ...
    logits_net_path = './saved_models/solo_escape_discrete/ppo/2020-08-26-15-13/logits_net/280'
    val_net_path = './saved_models/solo_escape_discrete/ppo/2020-08-26-15-13/val_net/280'
    # load models
