#! /usr/bin/env python
"""
Training two logger robots escaping a cell with Double Deep Q-network (DDQN)

Author: LinZHanK (linzhank@gmail.com)

Train new models example:
    python coop_escape_ddqn_train.py --num_episodes 10000 --num_steps 200 --normalize --time_bonus -0.0025 --wall_bonus -0.025 --door_bonus 0 --success_bonus 1 --layer_sizes 256 128  --update_step 10000 --decay_mode 'exp' --decay_rate 0.999 --final_eps 0.05
Continue training models example:
    python coop_escape_ddqn_train.py --source '2020-01-04-19-06' --num_episodes 15000
"""
...
if __name__ == "__main__":
    ...
    if not args.source: # source is empty, create new params
        ...
        load_dir_0 = os.path.dirname(sys.path[0])+"/saved_models/coop_escape/ddqn/"+args.source+"/agent_0"
        load_dir_1 = os.path.dirname(sys.path[0])+"/saved_models/coop_escape/ddqn/"+args.source+"/agent_1"
        ...
        # load ddqn models & memory buffers
        agent_0 = DoubleDQNAgent(agent_params_0)
    ...
    save_dir_0 = os.path.dirname(sys.path[0])+"/saved_models/coop_escape/ddqn/"+date_time+"/agent_0"
    save_dir_1 = os.path.dirname(sys.path[0])+"/saved_models/coop_escape/ddqn/"+date_time+"/agent_1"
